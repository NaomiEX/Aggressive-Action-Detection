...
def main(args):
    ...
    def build_optimizer(model, args):
        ...
        if args.optimizer.lower() == "adamw":
            ...
            optimizer = madgrad.MADGRAD(param_dicts, lr=args.lr, weight_decay=args.weight_decay)
        else:
...
if __name__ == '__main__':
    ...
    # args.output_dir = 'testing'
    # args.dataset_file = 'surveillance'
    # # args.sched = 'step'
    # # args.lr_drop = 40
    ...
    # # args.weight_standardization = True
    # args.predict_interaction_vector = True
