...
def get_args_parser():
    ...
    parser.add_argument('--root_path', default='/data/hico_20160224_det', type=str)
    parser.add_argument('--train_path', default='/data/hico_20160224_det/images/train2015', type=str)
    parser.add_argument('--test_path', default='/data/hico_20160224_det/images/test2015', type=str)
