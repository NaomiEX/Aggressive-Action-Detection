...
class HICOEvaluator():
    ...
    def evaluation_default(self):
        ...
        # print('--------DEFAULT--------')
        # print('mAP_def: {}   mAP_def_rare: {}   mAP_def_non_rare: {}'.format(mAP['mAP'], mAP['mAP_rare'], mAP['mAP_non_rare']))
        # print('--------------------')
    ...
    def evaluation_ko(self):
        ...
        # print(f'APs have been saved to {self.out_dir}')
        # print('--------KNOWN OBJECT--------')
        # print('mAP_ko: {}   mAP_ko_rare: {}   mAP_ko_non_rare: {}'.format(mAP['mAP'], mAP['mAP_rare'], mAP['mAP_non_rare']))
        # print('--------------------')
